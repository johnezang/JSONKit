...
<table>
  ...
  <tr><td valign="top"><code>JKParseOptionPermitFragment</code></td><td>Allow <code>true</code>, <code>false</code>, <code>null</code>, numbers, and strings as top-level values in addition to objects and arrays. The <a href="http://tools.ietf.org/html/rfc4627">JSON specification</a> only allows arrays and objects at the top-level. This options allows non-conforming JSON containing some other type of value to be parsed.</td></tr>
</table>
